...
```
**DoD status:** DoD UNVERIFIABLE · not checked · EXIT=n/a · 2026-09-06T16:55:44Z · `sh set -u cd "/Users/peterbeke/Developer/VS Code/AMZN API/Amazon_SP_API" || exit 1 G="/Users/peterbeke/Developer/VS Code/AMZN API/.claude/checks/spapi_doc_guard.py" python3 "$G" --selftest`
