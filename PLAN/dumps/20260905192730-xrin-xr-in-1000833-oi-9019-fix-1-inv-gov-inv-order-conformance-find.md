# Cross-repo instruction — XR-IN-1000833 from estatehub

> Filed via `xrepo-relay.py request`, tracked as `XR-IN-1000833` on this repo's own ledger — not a founder brain dump.
