# Push Amazon_SP_API doc surface to origin

- **Request id:** `XR-IN-1000067`
- **From repo:** `AMZN API/Amazon_SP_API`
- **To repo:** `AMZN API/amzn-api-integration`
- **Filed:** 2026-08-22T05:14:06Z
- **Instruction key:** `04839d783b63`
- **Originating rows:** —

> Filed by `xrepo-relay.py` under RULE-L24: cross-repo work is filed as an instruction, never handed back as a question.
> **When you have executed this, run:** `python3 ~/.claude/tools/xrepo-relay.py answer --id XR-IN-1000067 --body-file <what-you-did.md>`
